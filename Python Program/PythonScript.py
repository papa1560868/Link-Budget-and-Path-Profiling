...
Innotech Philippines:
    lat:         14.6267459
    Long:        120.9717312
    Elevation:   2.142042636871338

EARIST:
    lat:         14.299914
    Long:        121.0098214
    Elevation:   149.1667633056641
    
rev1.0 - Re checking of previous code.
rev2.0 - Append all data first  before storing to excel file.
rev3.0 - New inputs for Link Budget (Antenna Specs).
rev4.0 - Optimized Code.
rev4.1 - Storing of link budget data in excel.
rev5.0 - API Key on same window.
apiKey = 'AIzaSyAr65CtnyFV1n0F2GgALr06Dk5m8OCKE5Q'
"""
